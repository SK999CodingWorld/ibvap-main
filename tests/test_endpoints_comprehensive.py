...
class TestSimpleDashboardEndpoints:
    ...
    def test_api_health(self):
        ...
        # Verify component names match real workers
...
class TestMainEndpointsWithoutServices:
    """When services are not initialized, endpoints should return 503 instead of 500 crashes."""
    @classmethod
    def setup_class(cls):
...
class TestMainEndpointsWithActiveServices:
    """When services are active, test valid functionality and input validation."""
    @classmethod
    def setup_class(cls):
        # Mock StreamIngestService
    ...
    def test_camera_crud_operations(self):
        ...
        # Get non-existing camera -> 404
        res = self.client.get("/cameras/non_existing")
        assert res.status_code == 404

        # Create camera with valid payload
        ...
        # Update non-existing camera -> 404
        ...
        # Delete non-existing camera -> 404
    ...
    def test_alert_operations(self):
        ...
        # Acknowledge non-existing alert -> 404
    ...
    def test_recording_operations(self):
        ...
        # Evidence export with valid ISO timestamps
        ...
        # Evidence export with INVALID timestamps -> 400
